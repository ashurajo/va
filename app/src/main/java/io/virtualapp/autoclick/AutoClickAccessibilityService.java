...
public class AutoClickAccessibilityService extends AccessibilityService {
    ...
    String[] PACKAGES = {"me.kaede.androidmvppattern","cn.leancloud.rednow","com.cuimarker.lichi",};
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        android.util.Log.e(TAG, "------start------"+event.getPackageName()+"----"+event.getClassName().toString()+"----");
...
//            startActivity(intent);
        ...
        if(eventType==32){
            if(event!=null){
                android.util.Log.e(TAG, "---type-32------"+event.getPackageName()+"----"+event.getClassName().toString()+"----");
            }
            try {
