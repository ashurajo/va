package io.virtualapp.shadowsocks.ui;
...
import io.virtualapp.shadowsocks.core.AppInfo;
...
//        Log.e("start","isAppProxy--"+ AppProxyManager.Instance.isAppProxy("cn.leancloud.rednow"));
    }
    ...
    public void queryAppInfo() {
        ...
        if (AppProxyManager.Instance.mlistAppInfo != null) {
            ...
            for (ResolveInfo reInfo : resolveInfos) {
                ...
                if (!appInfo.getPkgName().equals("com.vm.shadowsocks"))//App本身会强制加入代理列表，之前集成vpn源码的包名 todo
...
class AppViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (proxied) {
            ...
            Log.e("start","item.getPkgName()---"+ item.getPkgName()+"---"+item.getAppLabel());
        }
        proxied = !proxied;
    }
}
