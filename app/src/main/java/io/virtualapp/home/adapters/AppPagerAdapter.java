...
import io.virtualapp.home.fragment.ListFragmentNet;
...
//        File storageFir = new File(Environment.getExternalStorageDirectory().getPath()+"/apk");
//        dirs.add(storageFir);
    }
    ...
    public Fragment getItem(int position) {
        if(position==0){
            return ListFragmentNet.newInstance();
        }else {
